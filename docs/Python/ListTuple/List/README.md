# Lists
List คือการจัดเก็บข้อมูลแบบใหม่ ที่จะจัดเก็บได้มากกว่าตัวแปร โดยปกติแล้ว น้องจะเก็บข้อมูลโดยการใช้แบบนี้ครับ
```python
my_var1 = 12
my_var2 = 24
my_var3 = 36
...
วิธีใช้งาน
```
<ตัวอักษรที่จะมาแบ่ง list>.join(<ตัวแปรที่เป็น list>)
```
